...
void Grid() {
  ...
  T_Tag_tr -> SetBranchAddress("drSV", & Tag_dr_SV);
  ...
  T_Probe_tr -> SetBranchAddress("drSV", & Probe_dr_SV);
  ...
  */
  ...
  for (int i = 0; i < T_Tag -> GetEntries(); i++) {
    ...
    selection[3] = ((Tag_dr_SV < 0.4) && (Tag_dr_SV > -10.0) && (Probe_dr_SV < 0.4) && (Probe_dr_SV > -10.0));
