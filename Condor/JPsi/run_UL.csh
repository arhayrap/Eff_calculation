...
cp -r -f /afs/cern.ch/user/a/arhayrap/scratch0/CMSSW_14_0_5/src/Eff_calculation/Condor/JPsi/Samples_JPsi_UL ./sample_names 
...
cp Trigger_ScaleFactors_OnMC.root /eos/user/a/arhayrap/JPsi_UL//output_file_$1.root 
rm -r -f * 
