...
cp -r -f /afs/cern.ch/user/a/arhayrap/scratch0/CMSSW_14_0_5/src/Eff_calculation/Condor/BParking/Samples_A_2_UL ./sample_names 
...
cp Trigger_ScaleFactors_OnBParking.root /eos/user/a/arhayrap/BParking_skimmed_A_2_UL//output_file_$1.root 
rm -r -f * 
